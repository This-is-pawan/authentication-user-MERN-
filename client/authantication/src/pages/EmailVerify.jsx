...
const EmailVerify = () => {
  ...
  const onSubmitHandler = async (e) => {
    e.preventDefault(); // FIXED TYPO: preventDefalut → preventDefault
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gradient-to-br from-blue-200 to-purple-400">
      ...
      >
        ...
        <button
          type="submit"
          className="w-full py-3 bg-gradient-to-r from-indigo-400 to-indigo-900 rounded-full text-white font-semibold"
        >
          Verify Email
        </button>
      </form>
